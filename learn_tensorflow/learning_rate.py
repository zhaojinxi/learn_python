...
all_decay = [exponential_decay, natural_exp_decay, inverse_time_decay, linear_cosine_decay, noisy_linear_cosine_decay, cosine_decay, cosine_decay_restarts, polynomial_decay]
