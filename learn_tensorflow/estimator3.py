...
def create_model(data_format):
    ...
    return tensorflow.keras.Sequential([
            tensorflow.keras.layers.Reshape(target_shape=input_shape, input_shape=(28 * 28,)),
            tensorflow.keras.layers.Conv2D(32,5,padding='same',data_format=data_format,activation=tensorflow.nn.relu),
            tensorflow.keras.layers.MaxPooling2D((2, 2), (2, 2), padding='same', data_format=data_format),
            tensorflow.keras.layers.Conv2D(64,5,padding='same',data_format=data_format,activation=tensorflow.nn.relu),
            tensorflow.keras.layers.MaxPooling2D((2, 2), (2, 2), padding='same', data_format=data_format),
...
def get_train_hooks(name_list, use_tpu=False, **kwargs):
    ...
    Args:
        ...
        LoggingTensorHook, ProfilerHook, ExamplesPerSecondHook, which are defined as keys in HOOKS
...
if data_format is None:
    data_format = ('channels_first' if tensorflow.test.is_built_with_cuda() else 'channels_last')
