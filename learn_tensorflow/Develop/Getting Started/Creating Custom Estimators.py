...
def my_model(features, labels, mode, params):
    ...
    if mode == tensorflow.estimator.ModeKeys.PREDICT:
        predictions = {'class_ids': predicted_classes[:, tensorflow.newaxis], 'probabilities': tensorflow.nn.softmax(logits), 'logits': logits,}
...
def main(argv):
    ...
    classifier = tensorflow.estimator.Estimator(model_fn=my_model,params={
