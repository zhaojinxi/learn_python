...
Saver = tensorflow.train.Saver(max_to_keep=0,keep_checkpoint_every_n_hours=0.5,filename='cnn')
...
for _ in range(max_step):
    AdamOptimizer._lr=tensorflow.train.exponential_decay(init_lr,global_step,max_step,0.01)
    ...
    try:
        ...
        if Session.run(global_step)%1000==0:
